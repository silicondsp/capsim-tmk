...
<li><a href="https://youtu.be/zOPLSd8vf14">Capsim Interconnect Buffer Management Synchronous and Asynchronous Dataflow <img src="images/yt_logo_rgb_light-300x67.png" width="86" height="18" alt=""/></a></li>	
<li><a href="https://youtu.be/PlKvXIm_i6E">Debugging Capsim C Block Diagram Simulations Applies Also to Text Mode Kernel <img src="images/yt_logo_rgb_light-300x67.png" width="86" height="18" alt=""/></a></li>
<li><a href="https://youtu.be/npliUoWNwtk">Fixed Point (Finite Wordlength) Simulation and Modeling of Digital Filters<img src="images/yt_logo_rgb_light-300x67.png" width="86" height="18" alt=""/></a></li>
</ol> 
...
<p>  From a terminal run the following commands:</p>
 ...
 <p> sudo apt-get install lzma</p>
 <p> sudo apt-get install bison</p></b>
<HR>
<div id="linux_tux">

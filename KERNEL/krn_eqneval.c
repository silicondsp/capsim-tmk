...
#line 40 "krn_eqneval.y"
                        { (yyval.val)=(yyvsp[-2].val) + (yyvsp[0].val);}
#line 1198 "y.tab.c"
    break;

  case 13: /* expr: expr '-' expr  */
#line 41 "krn_eqneval.y"
                        { (yyval.val)=(yyvsp[-2].val) - (yyvsp[0].val);}
#line 1204 "y.tab.c"
    break;

  case 14: /* expr: expr '*' expr  */
#line 42 "krn_eqneval.y"
                        { (yyval.val)=(yyvsp[-2].val) * (yyvsp[0].val);}
#line 1210 "y.tab.c"
    break;
...
#line 1225 "y.tab.c"
  ...
  case 17: /* expr: '(' expr ')'  */
#line 48 "krn_eqneval.y"
                        { (yyval.val)=(yyvsp[-1].val); }
#line 1231 "y.tab.c"
    break;

  case 18: /* expr: '-' expr  */
#line 49 "krn_eqneval.y"
                                    { (yyval.val) = -(yyvsp[0].val); }
#line 1237 "y.tab.c"
    break;

  case 19: /* expr: expr '^' expr  */
#line 50 "krn_eqneval.y"

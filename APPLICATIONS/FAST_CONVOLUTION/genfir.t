...
param int 256    length   "Enter number of samples"
...
param float 0.4    fh   "Upper cutoff freq. 0<=fh<=0.5"
...
param float 0.1    twidth   "Transition Width Chebyshev Window"
...
connect impulse0 0 firfil0 0  	{impulse0: —ÿ¿:é„,firfil0:x:float}
connect firfil0 0 spectrum0 0  	

...
# topology file:  test_tiff_wr_readback.t
...
param file output.tif    fileName   " File that contains  TIFF image "
...
param file tiff2.cmap    colorMap   "Color Map"
block prbimgdisp0755 imgdisp

connect imgrdtiff0 0 imgprasc0 0  	{imgrdtiff0:NULL:NULL,imgprasc0:x:image_t}

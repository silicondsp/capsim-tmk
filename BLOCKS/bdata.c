...
#define initialize (param_P[1]->value.d)
#define pace_rate (param_P[2]->value.f)
#define samples_first_time (param_P[3]->value.d)
/*-------------- BLOCK CODE ---------------*/
 int  
...
case PARAM_INIT: 
    {
     ...
     char   *pdef1 = "Initialization for shift register";
     char   *ptype1 = "int";
     char   *pval1 = "12";
     char   *pname1 = "initialize";
     char   *pdef2 = "pace rate to determine how many samples to output";
     char   *ptype2 = "float";
     char   *pval2 = "1.0";
     char   *pname2 = "pace_rate";
     char   *pdef3 = "number of samples on the first call if paced";
     char   *ptype3 = "int";
     char   *pval3 = "128";
     char   *pname3 = "samples_first_time";

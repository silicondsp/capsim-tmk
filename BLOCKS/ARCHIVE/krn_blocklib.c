...
extern add(),addnoise(),and(),ang(),arprocess(),
	...
	hilbert(),histtxt(),hold(),iirfil(),
	img_sar_azimuth_compress(),img_sar_create(),img_sar_range_compress(),imgaddnoise(),
	imgbreakup(),imgbuild(),imgcalc(),imgcxmag(),
	imgcxtrl(),imgfilter(),imggen(),imghisteq(),
	imginterp(),imgmanip(),imgmux(),imgnode(),
	imgnonlinfil(),imgprasc(),imgprbin(),imgproc(),
	imgrdasc(),imgrdbin(),imgrtcx(),imgserin(),
	imgserout(),imgshrink(),imgsink(),imgsubimg(),
	impulse(),intcntrl(),intdmp(),integrate(),
	invcust(),inventory(),inverse(),invert(),
	itf(),jitter(),jkfade(),jkff(),
	limiter(),linecode(),lms(),lpc(),
	lpf(),mau(),mbset(),mixer(),
	more(),mulaw(),multiply(),mux(),
	nand(),nl(),node(),nonlin(),
	nor(),null(),offset(),operate(),
	or(),phi_meter(),pllfilt(),plottxt(),
	pngen(),pngen2(),powmeter(),prbinimage(),
	predftf(),predlms(),prfile(),pri(),
	primage(),pulse(),pump(),qpsk(),
	quot(),radar(),rangen(),rdaiff(),
	rdbinimg(),rdfile(),rdimage(),rdmulti(),
	repeater(),replicate(),resmpl(),roundi(),
	rxhdlc(),sampler1(),sar_azimuth_ref(),sar_chirp(),
	sar_range(),sar_range_compress(),scattertxt(),scrambler(),
	sdet(),sdr(),secord(),seqgen(),
	server(),setsnr(),sine(),sink(),
	skip(),skipold(),slice(),slidefft(),
	sn74ls93(),spectrumtxt(),spiceprb(),spread(),
	sqr(),sqrtnyq(),srff(),srlatch(),
	stats(),stc(),stcode(),str(),
	strch(),stretch(),sum(),symimp(),
	target(),tee(),tff(),threshold(),
	toggle(),transpose(),trig(),txhdlc(),
	unitf(),v29decoder(),v29encoder(),v2b(),
	vcm(),vecbit(),wave(),wraiff(),
	xdco(),xnor(),xor(),xygen(),
	zc(),zdummy(),zero(),zlpf();

 ...
 *    PARAMETER DEFINES 
 */ 
#define filterKernel (param_P[0]->value.s)
#define freeImageFlag (param_P[1]->value.d)
/*-------------- BLOCK CODE ---------------*/
...
case PARAM_INIT: 
    {
     ...
     char   *pdef0 = "Filter Kernel";
     char   *ptype0 = "file";
     char   *pval0 = "filt.krn";
     char   *pname0 = "filterKernel";
     char   *pdef1 = "1=free input image, 0= don't";
     char   *ptype1 = "int";
     char   *pval1 = "0";
     char   *pname1 = "freeImageFlag";

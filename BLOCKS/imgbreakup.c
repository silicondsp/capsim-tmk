 ...
 *    PARAMETER DEFINES 
 */ 
#define subWidth (param_P[0]->value.d)
#define subHeight (param_P[1]->value.d)
...
case PARAM_INIT: 
    {
     ...
     char   *pdef0 = "Sub image width";
     char   *ptype0 = "int";
     char   *pval0 = "8";
     char   *pname0 = "subWidth";
     char   *pdef1 = "Sub image height";
     char   *ptype1 = "int";
     char   *pval1 = "8";
     char   *pname1 = "subHeight";

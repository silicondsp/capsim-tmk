 ...
 *    PARAMETER DEFINES 
 */ 
#define a (param_P[0]->value.f)
#define b (param_P[1]->value.f)
#define c (param_P[2]->value.f)
/*-------------- BLOCK CODE ---------------*/
 int  
...
case PARAM_INIT: 
    {
     ...
     char   *pdef0 = "linear coefficient";
     char   *ptype0 = "float";
     char   *pval0 = "1.0";
     char   *pname0 = "a";
     char   *pdef1 = "quadratic coefficient";
     char   *ptype1 = "float";
     char   *pval1 = "0.0";
     char   *pname1 = "b";
     char   *pdef2 = "cubic coefficient";
     char   *ptype2 = "float";
     char   *pval2 = "0.0";
     char   *pname2 = "c";

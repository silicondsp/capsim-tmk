...
#define x (state_P->__x)
#define p (state_P->__p)
#define xold (state_P->__xold)
#define yold (state_P->__yold)
...
#define delta (param_P[2]->value.f)
/*-------------- BLOCK CODE ---------------*/
 int  
...
case PARAM_INIT: 
    {
     ...
     char   *pdef0 = "The gain of the first integrator";
     char   *ptype0 = "float";
     char   *pval0 = "1.0";
     char   *pname0 = "g1";
     char   *pdef1 = "The gain of the second integrator";
     char   *ptype1 = "float";
     char   *pval1 = "1.0";
     char   *pname1 = "g2";
     char   *pdef2 = "Binary Quantizer Level";
     char   *ptype2 = "float";
     char   *pval2 = "1.0";
     char   *pname2 = "delta";
